...
import 'package:wclient/src/utils/inner_html.dart';
...
class ClockComponent {
  ...
  set textColor(String value) {
    _textColor = value;
    final element = root.querySelector('svg');
    if (element != null) {
      element.style.setProperty('fill', _textColor);
    }
  }

  set color(String value) {
    _color = value;
    root.style.backgroundColor = _color;
  }

  set image(String value) {
    _image = value;
    root.style.backgroundImage = _image;
  }

  set hourColor(String value) {
    _hourColor = value;
    final element = root.querySelector('.hours');
    if (element != null) {
      element.style.backgroundColor = _hourColor;
    }
  }
  ...
  set minuteColor(String value) {
    _minuteColor = value;
    // TODO
    final element = root.querySelector('.minutes');
    if (element != null) {
      element.style.backgroundColor = _minuteColor;
    }
  }
  ...
  void _updateView() {
    ...
    root.querySelector('svg').style.setProperty('fill', _textColor);
    root.style.backgroundColor = _color;
    root.style.backgroundImage = _image;
    root.querySelector('.hours').style.backgroundColor = _hourColor;
    root.querySelector('.minutes').style.backgroundColor = _minuteColor;
  }

  void _build() {
    // TODO background

    root.classes.addAll(['clock-holder']);

    final clock = DivElement()..classes.addAll(['clock']);

    // Marks
    clock.children.add(DivElement()
    ...
    // Sticks
    clock.children.add(_hoursContiner);
    clock.children.add(_minutesContainer);
    // TODO clock.children.add(_secondsContainer);
